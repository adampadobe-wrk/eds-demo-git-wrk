 ...
 */
(function(n,o){var c="alloy";o.forEach(function(x){n[x]||((n.__alloyNS=n.__alloyNS||[]).push(x),n[x]=function(){var u=arguments;return new Promise(function(r,j){n[x].q=n[x].q||[],n[x].q.push([u,r,j])})},n[x].q=[])});})(window,[c]);
